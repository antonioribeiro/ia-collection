...
class SupportCollectionTest extends TestCase
{
    ...
    {
        $item1 = m::mock('IlluminateAgnostic\Collection\Contracts\Support\Arrayable');
        $item1->shouldReceive('toArray')->once()->andReturn('foo.array');
        $item2 = m::mock('IlluminateAgnostic\Collection\Contracts\Support\Arrayable');
    ...
    public function testWhere()
    {
        ...
        $c = new Collection([['v' => 1], ['v' => new \IlluminateAgnostic\Collection\Support\HtmlString('hello')]]);
        $this->assertEquals(
            [['v' => new \IlluminateAgnostic\Collection\Support\HtmlString('hello')]],
        ...
        $this->assertEquals(
            [['v' => 'hello']],
            $c->where('v', new \IlluminateAgnostic\Collection\Support\HtmlString('hello'))->values()->all()
        );
    }
